...
// lowerFlag() and printStatus(). The flag and the upDown resource is
// encapsulated in the class there are no direct ways to manipulate the flag
// or updown other than the variables.  This form of encapsulation ensures
// consistiency
